...
namespace JobScraper.Infrastructure.Migrations
{
    ...
    [Migration("20250113183154_TechnologyTag")]
    partial class TechnologyTag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobListingTechnologyTag", b =>
                {
                    b.Property<int>("JobListingsId")
                        .HasColumnType("integer");

                    b.Property<int>("TechnologyTagsId")
                        .HasColumnType("integer");

                    b.HasKey("JobListingsId", "TechnologyTagsId");

                    b.HasIndex("TechnologyTagsId");

                    b.ToTable("JobListingTechnologyTag");
                });
            ...
            modelBuilder.Entity("JobScraper.Domain.Entities.TechnologyTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("JobListingTechnologyTag", b =>
                {
                    ...
                    b.HasOne("JobScraper.Domain.Entities.TechnologyTag", null)
                        .WithMany()
                        .HasForeignKey("TechnologyTagsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
